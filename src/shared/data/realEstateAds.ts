export default [
  ...
  },
  {
    ...
    rating: '3',
    location: 'Ile de France - Paris 11e',
    equipments: ['Vue Parc', 'Chauffage', 'Sèche linge', 'Sèche Cheveux', 'Wi-fi', 'Ascenseur'],
  ...
  },
  {
    ...
    equipments: ['Rangements', 'Lit', 'Sèche Cheveux', 'Wi-fi', 'TV', 'Bouilloire'],
  ...
  },
  {
    ...
    equipments: ['SDB', 'Cuisine équipée', 'Toilettes sèches', 'Frigo', 'Bouilloire'],
  ...
  },
  {
    ...
    equipments: ['Télévision', 'Four', 'Frigo', 'Hotte', 'Wi-fi', 'Micro-Ondes'],
  ...
  },
  {
    ...
    equipments: ['Équipements de base', 'Four', 'Frigo', 'Wi-fi', 'Micro-Ondes'],
  ...
  },
  {
    ...
    rating: '4',
    location: 'Ile de France - Paris 13e',
    equipments: ['Wi-fi', 'Équipements de base', 'Micro-Ondes', 'Frigo', 'Baignoire'],
